...
fetch("http://localhost:3002/players/login", {
    ...
    body: JSON.stringify(data),
          ...
          .then((data) => {
            const jwt = data.token; // Récupérer le JWT depuis la réponse de l'API
    console.log(jwt)
            ...
            // Par exemple, vous pouvez utiliser le navigateur du React Router pour rediriger vers une page spécifique
                      ...
                      <div className="card-body p-2 p-lg-2 text-black">
                        ...
                        <form onSubmit={connection}>        
                          ...
                          <div className="form-outline mb-2 mb-md-1">
                            <input type="email"  name="emailPlayer" className="form-control form-control-lg" />
                            <label className="form-label" htmlFor="emailPlayer">Votre adresse mail</label>
                          </div>
                          ...
                          <div className="pt-1 mb-1 mb-md-0">
                            <button className="btn effectV btn-sm btn-block bg-fva-vert-f text-white fw-bold" type="submit">CONNEXION</button>
                          </div>
