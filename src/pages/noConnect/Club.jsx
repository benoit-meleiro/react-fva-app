        ...
        <div className="container">
              ...
              <section className="text-center">
                <div className="row justify-content-around color-fvaRouge">
                  ...
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2">
                    <img
                      src="/img/Jean_Tourloupe.jpg"
                      alt="icone du président"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-rouge"
                    />
                  ...
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2">
                    <img
                      src="/img/Al_Anbique.jpg"
                      alt="icone du secrétaire de bureau"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-rouge"
                    />
                  ...
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2">
                    <img
                      src="/img/Marthe_Ini.jpg"
                      alt="icone de la trésorière de bureau"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-rouge"
                    />
                  ...
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2">
                    <img
                      src="/img/Olivier_Tnam.jpg"
                      alt="icone de l'adjoint du président"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-rouge"
                    />
                ...
                <div className="row justify-content-around ">
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2 m-auto color-fvaBleu">
                    <h4 className="fw-bold mb-0 text-uppercase ">
                      capitaines interclubs
                    </h4>
                  </div>
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2 color-fvaBleu">
                    <img
                      src="/img/Tara_Clure.jpg"
                      alt="icone de la capitaine equipe 1"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-bleu"
                    />
                  ...
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2 color-fvaBleu">
                    <img
                      src="/img/Jenny_Fraireniseur.jpg"
                      alt="icone de jeune joueuse symbolisant l'âge des adhérents"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-bleu"
                  ...
                  <div className="col-6 col-sm-4 col-md-4 col-lg-2 color-fvaBVert">
                    <img
                      src="/img/Elsa_Rose.jpg"
                      alt="icone de jeune joueuse symbolisant l'âge des adhérents"
                      width="48"
                      height="48"
                      className="d-inline-block align-text-top rounded-pill border-fva-vert"
                    />
          ...
          <section>
            <div className="container">
              ...
              <hr className="hr-danger" />
              <p className="mb-lg-4">
                Vous pouvez suivre leurs résultats sur BADNET
              </p>
              <div className="row justify-content-around mb-3">
                <div className="card col-12 col-lg-5 p-0 border-fva-bleu mb-3">
                  <img
                    src="/img/equipe1-fva.jpg"
                  ...
                  <div className="card-body color-fvaBleu text-center">
                    <div className="d-flex flex-row justify-content-around">
                      <h4 className=" lh-1">
                        Equipe 1 FVA
                        <br />
                        <span className="fs-6 fw-normal">Division 3</span>
                      </h4>
                      <h4 className=" lh-1">
                        Sabrina MAUREL
                        <br />
                        <span className="fs-6 fw-normal">Capitaine</span>
                      </h4>
                    </div>
                    <div className="d-flex flex-row justify-content-around">
                      <ul>
          ...
          <section className="mb-5">
            ...
            <div className="container text-center">
              ...
              <p>
                Les frais d'inscription à tous les TDJ plus 5 autres tournois
                offerts par le club (s'adresser à Stéphanie)
              </p>

              <h4>Pour les autres adhérents</h4>

              <p>
                Jeunes -18 ans = tous les TDJ plus 5 autres tournois offerts par
                le club
                <br />
                Séniors et vétérans = 3 tournois dans la saison offerts par le
                club
              </p>
              ...
              <p>
                Si votre tournoi est offert = contacter le club par mail pour
                vous inscrire
                <br />
                Si vous avez dépassé votre quota de tournois offerts = vous
                devez vous inscrire depuis BADNET
              </p>
